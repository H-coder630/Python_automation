...
def Send_Email(filename):
    ...
    body = " Hello I am Harshada Phalle,This is an auto-generated python script of Duplicate files in the system, just for checking purpose I sending the mail to you if you are got this email then simply reply me back thank you"

    sender_email = "harshadaphalle@gmail.com"
    receiver_email = "mayurphalle4@gmail.com"
    # "nitinc793@gmail.com"
